  ...
  public class WinAPI_Interop
  {
    ...
    public static void CreateProcess(string ChildProcName)
    {
                              ...
                              ))
      {
        ...
        {
          int d = (int)ppSessionInfo + nCount * Marshal.SizeOf(typeof(WTS_SESSION_INFO));
          WTS_SESSION_INFO tSessionInfo = (WTS_SESSION_INFO)Marshal.PtrToStructure(new IntPtr(d), typeof(WTS_SESSION_INFO));
